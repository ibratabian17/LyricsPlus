...
build:
	...
	$(GO) build -trimpath -ldflags "$(LDFLAGS)" -o bin/account_manager ./cmd/account_manager
	@echo "built $(BINARY), bin/gdrive_sync, and bin/account_manager (version $(VERSION), commit $(COMMIT), built $(BUILD_DATE))"
